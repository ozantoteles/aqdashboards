...
def plot_scatter3_pm1(time, data):
    pm1 = go.Scatter(
        y=list(data[:, 1]),
...
def plot_scatter3_pm2_5(time, data):
    pm2_5 = go.Scatter(
        y=list(data[:, 2]),
...
def plot_scatter3_pm10(time, data):
    pm10 = go.Scatter(
        y=list(data[:, 3]),
...
def plot_scatter3_voc(time, data):
    voc = go.Scatter(
        y=list(data[:, 7]),
...
def plot_scatter3_nox(time, data):
    nox = go.Scatter(
        y=list(data[:, 8]),
...
def plot_scatter3_bat(time, data):
    bat = go.Scatter(
        y=list(data[:, 4]),
